...
class Runner:
    def __init__(self, env_name, loops=300, max_depth=1000, playouts=10000):
    ...
    def run(self):
        ...
        # env.monitor.close()
        print("terminated with average best reward", sum(best_rewards)/len(best_rewards))


def main():
    Runner('NChain-v0', loops=10, playouts=3000, max_depth=50).run()
